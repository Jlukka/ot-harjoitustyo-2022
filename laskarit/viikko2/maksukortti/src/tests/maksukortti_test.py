...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_edullisen_lounaan_osto_onnistuu_kortilla_ollessa_vain_sen_arvo(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_maukkaan_lounaan_osto_onnistuu_kortilla_ollessa_vain_sen_arvo(self):
